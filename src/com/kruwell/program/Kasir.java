...
public class Kasir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/kruwell/program/images/registration_15px.png"))); // NOI18N
        ...
        jLabel24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/kruwell/program/images/coins_15px.png"))); // NOI18N
        ...
        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/kruwell/program/images/staff_15px.png"))); // NOI18N
        ...
        jLabel28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/kruwell/program/images/document_15px.png"))); // NOI18N
        ...
        Layout_daftarMember.add(saveEditProfile1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 340, -1, -1));
        ...
        if (tabel_riwayatTransaksi2.getColumnModel().getColumnCount() > 0) {
            tabel_riwayatTransaksi2.getColumnModel().getColumn(0).setResizable(false);
            tabel_riwayatTransaksi2.getColumnModel().getColumn(1).setResizable(false);
            tabel_riwayatTransaksi2.getColumnModel().getColumn(1).setPreferredWidth(450);
        }
        ...
        if (tabelTransaksi.getColumnModel().getColumnCount() > 0) {
            ...
            tabelTransaksi.getColumnModel().getColumn(3).setHeaderValue("Diskon");
        ...
        Layout_tukarPoin.add(txt_totalPoinBelanja, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 280, 140, 20));

        jLabel30.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel30.setText("ID Pelanggan :");
        Layout_tukarPoin.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, -1));
        Layout_tukarPoin.add(tf_idPelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 20, 170, -1));

        txt_poinPelanggan.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        Layout_tukarPoin.add(txt_poinPelanggan, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 180, 20));

        jLabel38.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel38.setText("Poin dimiliki :");
        Layout_tukarPoin.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 20, 100, -1));

        jLabel36.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel36.setText("Total Poin diperlukan : ");
        Layout_tukarPoin.add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 280, 160, -1));
    ...
    private void passwordSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_passwordSaveMouseClicked
        try{
            ...
            rs.next();
            if(passwordBaru.getText().equals(rs.getString(1))){
    ...
    private void btn_tukarPoinMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_tukarPoinMousePressed
        ...
        tf_idPelanggan.getDocument().addDocumentListener(new DocumentListener() {
    ...
    public void setTableData3Col(JTable dataTable){
        try{
            ...
            sql="SELECT idAkun,nama,tglMasuk FROM akun WHERE jabatan='Kasir'";
            rs=stat.executeQuery(sql);
            if(rs.next()){
                rs.last();
                rows=rs.getRow();
    ...
    public void addListenerTukarPoin(){
